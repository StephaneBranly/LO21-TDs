...
void Pile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Pile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Pile::modificationEtat)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Pile::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Pile.data,
    qt_meta_data_Pile,
    qt_static_metacall,
    nullptr,
    nullptr
